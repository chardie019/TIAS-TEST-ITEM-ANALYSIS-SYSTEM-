  ...
  <div class="col-lg-12">
       <div class="panel panel-info">
              <div class="panel-heading">
                <strong class="panel-title">WELCOME <?php echo $user=$_COOKIE['user']; ?></strong>
              <?php echo $_SESSION['user']['Lastname'];?>, <?php echo $_SESSION['user']['Firstname'];?> <?php echo $_SESSION['user']['Middlename'];?></a> <i class="fa fa-user"></i>|
              </div>
