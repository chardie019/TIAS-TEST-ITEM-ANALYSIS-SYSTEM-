...
{			
    ...
    sOut += '<tr><td>FULLNAME:</td><td>'+aData[2]+'  ' + "," +aData[3]+ ' ' +aData[4]+'</td></tr>';
    sOut += '<tr><td>USERNAME:</td><td>'+aData[5]+'</td></tr>';
     sOut += '<tr><td>USERTYPE:</td><td>'+aData[5]+'</td></tr>';
    sOut += '<tr><td>EXTRA INFORMATION:</td><td>Usertype : '+aData[6]+'</td></tr>';
    sOut += '</table>';
