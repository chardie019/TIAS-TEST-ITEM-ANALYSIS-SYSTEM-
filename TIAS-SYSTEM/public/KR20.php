        ...
        <thead>
              ...
              ?>
                  ...
                  <tr>
                   ...
                   <td>
                        <a type="button" value="Test Loading" onclick="fShowLoading();" href="kr20result.php?exam_id=<?php echo htmlentities($row['exam_id']); ?>" ><i class="fa fa-bar-chart-o fa-2x"></i>Perform(Test Reliability)</a>               
                    </td>
