...
$questions_list = get_non_rated_questions($where); 
...
$questions_list = get_all_questions_limit_nonrated($start,$limit,$where);
...
.legend .superawesome { background-color: #0EAF0E ; }
      ...
      <div class="col-lg-24">
       <div class="panel panel-primary">
              <div class="panel-heading">
                ...
                <h3 class="panel-title">QUESTION BANK (UN-EVALUATED QUESTIONS) </h3>
              </div>
 ...
 <div>
    ...
    $cnt++;
             ...
             $discardStyle = ($row['is_discarded'] == 0)?"color:#333 !important;":"";
             ...
             ?>
                     <td>
                        <a href="edit-question1.php?question_id=<?php echo htmlentities($row['question_id']); ?>" ><i class="fa fa-edit fa-2x"></i> Edit</a>                           
                    </td><?php } ?>
                     <td>
