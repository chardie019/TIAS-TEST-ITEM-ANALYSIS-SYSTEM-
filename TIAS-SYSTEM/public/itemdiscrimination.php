    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <thead>
                  ...
                  <th>INDEX OF DISCRIMINATION   <i class="fa fa-sort"></i></th>
              ...
              ?>
                  ...
                  <tr>
                   ...
                   <td>
                        <a type="button" value="Test Loading" onclick="fShowLoading();" href="itemdiscriminationresult.php?exam_id=<?php echo htmlentities($row['exam_id']); ?>" ><i class="fa fa-bar-chart-o fa-2x"></i>PERFORM</a>               
                    </td>
