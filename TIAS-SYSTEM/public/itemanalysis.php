...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1>ITEM ANALYSIS <small>Control Panel</small></h1>
        <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">List Of Examinations</h3>
            </div>
        ...
        <thead>
                  ...
                  <th>TEST RELIABILITY<i class="fa fa-sort"></i></th>
              ...
              ?>
                  ...
                  <tr>
                   ...
                   <td>
                        <a type="button" value="Test Loading" onclick="fShowLoading();" href="analyzedata.php?exam_id=<?php echo htmlentities($row['exam_id']); ?>" ><i class="fa fa-bar-chart-o fa-2x"></i>Perform(Item Analysis)</a>               
                    </td>
