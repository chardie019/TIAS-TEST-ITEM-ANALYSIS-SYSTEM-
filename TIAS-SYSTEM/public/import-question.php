                    ...
                    <form class="form-horizontal" action="import-question.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group pull-right">
                        <label for="submit-import-mc-question"></label>
                          <button type ="submit" id="submit-import-mc-question" name="submit-import-mc-question" value="submit-import-mc-question" class="btn btn-primary">Upload Questions</button>
					  </div>
