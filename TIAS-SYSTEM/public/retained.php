...
if($key !="")
{
  if($where != "")
    ...
    $where .= " question_text like '%{$key}%' AND is_discarded = 3";
}
...
$questions_list = get_retained_rated_questions($where); 
...
$questions_list = get_all_retainedquestions_limit_nonrated($start,$limit,$where);
      ...
      <div class="col-lg-24">
       <div class="panel panel-primary">
              <div class="panel-heading">
                ...
                <h3 class="panel-title">QUESTION BANK (RETAINED QUESTIONS) </h3>
              </div>
